...
export default function Navigation() {
  ...
  const links = [
    ...
    { 
      href: "/charts/external", 
      label: `${selected === 'birth' ? 'Transit & Horary' : 'Partner Natal'}`
    },
    { 
      href: "/charts/comparison", 
      label: `${selected === 'birth' ? 'Natal & Transit' : 'Synastry'}`
    },
    { href: "/charts/progression", label: "Progression" },
    { href: "/charts/draconic", label: "Draconic" },
    ...(unknownTime?.birth 
      ? [] 
      : [{ href: "/charts/perfection", label: "Ann. Perfection" }]
    ),
  ];
